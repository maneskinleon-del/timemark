            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="col-span-1 lg:col-span-8 h-full">
                <section className="glass-card rounded-xl flex flex-col overflow-hidden h-[500px] lg:h-full min-h-[500px]">
                  ...
                  {previewImage && (
                    <div className="p-4 md:p-6 bg-surface-container-low/50 flex flex-col gap-3 border-t border-outline-variant/30 shrink-0">
                      <div className="flex flex-wrap gap-3">
                        <button
                          onClick={openTimeModal}
                          disabled={isRendering}
                          className={`flex-1 min-w-[100px] border border-outline-variant/50 hover:bg-surface-container text-on-surface rounded-lg font-bold py-3 transition-colors flex justify-center gap-2 ${isRendering ? 'opacity-50 cursor-not-allowed' : ''}`}
                        >
                          <Clock size={18} /> Hora
                        </button>
                        <button
                          ...
                          disabled={isRendering}
                          className={`flex-1 min-w-[100px] bg-surface-container-highest text-on-surface rounded-lg font-bold border border-outline-variant/50 hover:bg-surface-variant transition-colors py-3 ${isRendering ? 'opacity-50 cursor-not-allowed' : ''}`}
                        >
